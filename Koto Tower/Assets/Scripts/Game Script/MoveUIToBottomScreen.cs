...
public class MoveUIToBottomScreen : MonoBehaviour
{
    ...
    void moveUIToBottomBehave()
    {
        ...
        if (currentValue - (rectHeight / 10) <= rectHeight * -1f && !GameManager.instance.isSelectTower && !GameManager.instance.isSelectTrap && GameManager.instance.currentStatus != GameStatus.SELECTING_TOWER)
